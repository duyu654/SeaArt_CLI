...
```bash
curl -L -o sac https://github.com/duyu654/SeaArt_CLI/releases/download/v0.4.15/sac-0.4.15-darwin-arm64
...
```bash
curl -L -o sac https://github.com/duyu654/SeaArt_CLI/releases/download/v0.4.15/sac-0.4.15-darwin-x64
chmod +x sac && mkdir -p "$HOME/.local/bin" && mv sac "$HOME/.local/bin/sac"
```
...
```bash
curl -L -o sac https://github.com/duyu654/SeaArt_CLI/releases/download/v0.4.15/sac-0.4.15-linux-x64
chmod +x sac && mkdir -p "$HOME/.local/bin" && mv sac "$HOME/.local/bin/sac"
```

#### Windows x64

Download `sac-0.4.15-windows-x64.exe` from the release page and place it somewhere in your `PATH`.
...
Current release: [`v0.4.15`](https://github.com/duyu654/SeaArt_CLI/releases/tag/v0.4.15)
